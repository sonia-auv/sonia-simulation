...
namespace RosMessageTypes.SoniaCommonRos2
{
    ...
    {
        public const string k_RosMessageName = "sonia_common_ros2/MpcInfo";
        ...
        public MpcGainsMsg current_gains;
        ...
        public MpcInfoMsg()
        {
            ...
            this.mpc_status = 0;
            this.mpc_mode = 0;
            this.current_gains = new MpcGainsMsg();
        }

        public MpcInfoMsg(bool is_mpc_alive, bool target_reached, bool is_trajectory_done, bool[] thrusters_status, sbyte mpc_status, byte mpc_mode, MpcGainsMsg current_gains)
        {
            ...
            this.current_gains = current_gains;
        }
        ...
        private MpcInfoMsg(MessageDeserializer deserializer)
        {
            ...
            this.current_gains = MpcGainsMsg.Deserialize(deserializer);
        }
        ...
        public override void SerializeTo(MessageSerializer serializer)
        {
            ...
            serializer.Write(this.current_gains);
        }
        ...
        public override string ToString()
        {
            ...
            "\ncurrent_gains: " + current_gains.ToString();
        }
